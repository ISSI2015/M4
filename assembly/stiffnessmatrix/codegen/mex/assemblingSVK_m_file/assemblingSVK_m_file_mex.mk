START_DIR = /home/ksimon/Code/ISSI/Assembly/StiffnessMatrix

MATLAB_ROOT = /home/ksimon/Software/Matlab/matlabR2013a
MAKEFILE = assemblingSVK_m_file_mex.mk

include assemblingSVK_m_file_mex.mki


SRC_FILES =  \
	assemblingSVK_m_file_mexutil.c \
	assemblingSVK_m_file_data.c \
...
MEX_FILE_NAME_WO_EXT = assemblingSVK_m_file_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/assemblingSVK_m_file"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/assemblingSVK_m_file/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/assemblingSVK_m_file/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/assemblingSVK_m_file/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
